...
import bannerImage from "/mnt/data/div.jpeg"; // Use your actual image path or import

const RelationshipSection = () => {
  return (
    <section className="relative bg-pink-500 rounded-3xl max-w-7xl mx-auto px-6 py-12 my-12 flex flex-col md:flex-row items-center overflow-hidden">
      {/* Left text */}
