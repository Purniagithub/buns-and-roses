...
const RelationshipSection = () => {
  return (
    <section className="relative bg-pink-500 rounded-3xl max-w-7xl h-64 mx-auto px-6 py-12 my-12 flex flex-col md:flex-row items-center overflow-hidden">
      {/* Left text */}
      <div className="md:w-1/2 text-white text-center md:text-left z-10">
        <h2 className="text-3xl md:text-4xl font-bold mb-3 leading-tight">
          Enriching Relationships <span className="inline-block ml-2"></span>
        </h2>
